...
$myurl=dirname($protocol.$_SERVER['HTTP_HOST']);
$config['baseurl'] = "$myurl";
$config['page_title'] = "群晖魔兽世界";
...
game_version
    Your game version
=====================================================================*/
$config['realmlist'] = 'wow.myserver.com';
...
=====================================================================*/
$config['db_auth_host'] = 'ac-database';$config['db_auth_port'] = 3306;
$config['db_auth_user'] = 'root';
$config['db_auth_pass'] = 'wow@asm0x1';
...
$config['realmlists'] = array(
    "1" => array(
        'realmid' => 1, // Realm ID
        'realmname' => "群晖魔兽世界", // Realm Name
        'db_host' => 'ac-database', 'db_port' => 3306, // MySQL Unix Socket
        'db_user' => 'root', // MySQL username
        'db_pass' => 'wow@asm0x1', // MySQL password

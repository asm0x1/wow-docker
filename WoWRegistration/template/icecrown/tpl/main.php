    ...
    <div class="main-box">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade in <?php echo((empty($error_error) && empty($success_msg)) ? 'active' : ''); ?>"
                        ...
                        <p style="text-align: justify;text-indent: 2em"  >
                            魔兽世界的背景故事缘起于《冰封王座》四年后的艾泽拉斯大陆。随着阿克蒙德的恶魔燃烧军团在海加尔山被击退，以及阿尔萨斯和巫妖王合为一体使天灾军团的亡灵陷入沉睡，大陆上的联盟与部落两大势力逐渐形成了对立状态，而新的威胁却正在不断产生。在杜隆塔尔的旱土上，由萨尔所领导的部落安顿定居下来并继续扩充军队的规模，他们邀请被遗忘者加入兽人、牛头人和巨魔的行列。同时，矮人、侏儒和古老的暗夜精灵也发誓效忠由人类王国暴风城所领导的联盟。在暴风城国王瓦里安·乌瑞恩神秘失踪后，大领主伯瓦尔‧弗塔根担任摄政王一职，但是伪装成人类女贵族的黑龙军团的奥妮克希亚控制他的心智，从幕后操控整个王国。正当英雄们探查奥妮克希亚的阴谋时，古老的强敌却现身世界各地，威胁著部落和联盟。
                        </p>
        ...
        <div class="col-md-4 sidebar">
           ...
           <div class="box1">
                群晖套件安装教程
                <hr style="border-color: #00CCFF;">
				<iframe src="//player.bilibili.com/player.html?aid=1200623480&bvid=BV1wF4m177B7&cid=1440853893&p=1&autoplay=0&danmaku=0" width="100%"
                        height="230" allowtransparency="true" frameborder="0"></iframe>
                <!--<iframe src="//player.bilibili.com/player.html?aid=1200623480&bvid=BV1wF4m177B7&cid=1440853893&p=1" width="330"
